module Common::V1
  class Root < Grape::API
    ...
    helpers Common::V1::Helpers::Base
    ...
    rescue_from :all do |e|
      Utils::DingNotifier.error("CommonApiError", e)
    ...
    # 路由挂载
    mount Common::V1::Captchas
    mount Common::V1::Qinius
    mount Common::V1::Callbacks
    mount Common::V1::VerificationCodes

    # NOTE 用于生成swagger.json文件的配置
    add_swagger_documentation \
      doc_version: '0.0.1', # 当前API版本号
      base_path: '/api/common',
      ...
      tags: [ # 分类标签，默认会根据Grape的namespace生成，此处单独用来声明分类描述
        { name: 'captchas', description: '图形验证码' },
        { name: 'qinius', description: '七牛' },
        { name: 'callbacks', description: '回调地址' },
        { name: 'verification_codes', description: '验证码' }
      ]
  end
end
